...
class Student(models.Model):
    ...
    doa=models.DateField(default='1998-01-01')
    pincode = models.CharField( default ='',max_length=12)
    admissionquota =models.CharField(max_length=50)
    cetno = models.CharField( default ='',max_length=12)
    branch =models.CharField(max_length=50)
    nationality=models.CharField( default ='',max_length=12)
    caste=models.CharField( default ='',max_length=12)
    category= models.CharField( default ='',max_length=12)
    email=models.CharField( default ='',max_length=120)
    sslc=models.CharField( default ='',max_length=120)
    pucdip= models.CharField( default ='',max_length=120)
...
class Notes(models.Model):
    Notes_id = models.UUIDField(primary_key=True,null=False)
    Notes_title = models.CharField(null=False,blank=False,max_length = 100)
    Notes_file = models.FileField(blank= False,null = False,upload_to='notes')
    Dept = models.ForeignKey(Dept,models.CASCADE)
    course = models.ForeignKey(Course,on_delete=models.CASCADE)
    teacher = models.ForeignKey(Teacher,on_delete=models.CASCADE)
    timestamp = models.DateTimeField(auto_now_add = True)
    module = models.CharField(max_length=10,choices=Module)
