...
from .models import Dept, Class, Notes, Student, Attendance, Course, Teacher, Assign, AttendanceTotal, time_slots, \
...
def add_student(request):
    ...
    if request.method == 'POST':
        ...
        admissionquota = request.POST['admissionquota']
        ...
        pucdip = request.POST['pucdip']
        cetno = request.POST['cetno']
...
class NoteCreateview(LoginRequiredMixin,UserPassesTestMixin,UpdateView):
    model= Notes
    template_name = ''
    fields = ['notes_title','notes_file','Dept','Course','module']
